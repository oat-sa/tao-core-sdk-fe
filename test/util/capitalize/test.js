...
define(['util/capitalize', 'lodash'], function (capitalize, _) {
    ...
    QUnit.test('util api', function (assert) {
        ...
        assert.equal(
            capitalize('lorem ipsum dolor sit amet', false),
            'Lorem ipsum dolor sit amet',
            'Multiple words, 2nd arg set to false'
        );
        assert.equal(
            capitalize('lorem ipsum dolor sit amet', null),
            'Lorem Ipsum Dolor Sit Amet',
            'multiple words, 2nd arg null (must be bool)'
        );
