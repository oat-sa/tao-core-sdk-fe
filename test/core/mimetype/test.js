define(['core/mimetype'], function(mimeType) {
    ...
    QUnit.cases
        .init([
            ...
            {
                url: '/test/core/mimetype/samples/unknown',
                type: null,
                error: true,
    ...
    QUnit.cases
        .init([
            ...
            //If the File has a generic typed mime, the mime type resolution will be based on the file extension
            {
                ...
                mime: 'invalid/octet-stream',
                equals: 'text/plain',
                title: 'invalid/octet-stream text'
            },
            {
                filename: 'filename.pdf',
                mime: 'invalid/octet-stream',
                equals: 'application/pdf',
                title: 'invalid/octet-stream pdf'
            },
            {
                filename: 'filename.pdf',
                mime: 'application/octet-stream',
                equals: 'application/pdf',
                title: 'application/octet-stream pdf'
            },
            {
                filename: 'filename.pdf',
                mime: 'application/force-download',
                equals: 'application/pdf',
                title: 'application/force-download pdf'
            },
