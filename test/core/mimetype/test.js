define(['core/mimetype'], function(mimeType) {
    ...
    QUnit.cases.init([
        {url: '/test/core/mimetype/samples/audio.mp3', type: 'audio/mpeg; charset=utf-8', error: false, title: 'MP3'},
        {url: '/test/core/mimetype/samples/video.mp4', type: 'video/mp4; charset=utf-8', error: false, title: 'MP4'},
        {url: '/test/core/mimetype/samples/unknown', type: null, error: true, title: 'Unknown resource'}
